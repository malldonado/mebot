  ...
  return (
    <div className="m-auto relative w-full">
      <div className='w-[90%] mt-8 mx-auto mb-auto h-full p-0 z-[1000] overflow-y-hidden'>
        ...
        <div className="mt-10">
          <h2 className="text-[26px] font-bold nunito-font text-[#121F33]">Login</h2>
          ...
          <form className="mt-6 m-auto" action="">
            ...
            <input
              className="w-full block outline-none border-[1px] border-gray-300 rounded-md	h-[40px] p-2 text-[#121F33] font-bold nunito-font mt-2 mb-4 placeholder:font-normal"
              type="email"
              placeholder="E-mail"
            />
            <label
